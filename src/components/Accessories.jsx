...
export default function AccessoriesCard({ data, disableScroll = false }) {
    ...
    return (
      <Container className={`accessories-container text-center ${disableScroll ? 'no-scroll' : ''}`}>
        {!disableScroll && (
          <>
        ...
        <div
          id="card-con"
          ref={scrollContainer}
          className={`accessories-wrapper ${disableScroll ? 'wrap-grid' : ''}`}
        >
          {data.map((value, ind) => (
